...
class FaqScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Quick Start Guide
            _buildSectionTitle(context, 'शुरुआत कैसे करें', Icons.play_circle_outline),
            const SizedBox(height: 12),
            _buildQuickStartCard(context),
            const SizedBox(height: 24),

            // FAQ Section
            _buildSectionTitle(context, 'अक्सर पूछे जाने वाले सवाल', Icons.quiz_outlined),
            const SizedBox(height: 12),
    ...
    return CustomCard(
      child: Column(
        ...
        children: [
          ...
          _buildStep(context, '1', 'डैशबोर्ड पर + बटन दबाएं', Icons.add_circle_outline),
          const SizedBox(height: 12),
          _buildStep(context, '2', 'अपनी कॉल काउंट और लॉगिन टाइम भरें', Icons.edit_outlined),
          const SizedBox(height: 12),
          _buildStep(context, '3', 'Save करें और अपनी प्रगति देखें', Icons.save_outlined),
        ],
      ),
    );
  }
    ...
    final faqItems = [
      {
        ...
        'answer': 'डैशबोर्ड पर नीचे दाईं ओर + (प्लस) बटन दबाएं। फिर तारीख, लॉगिन टाइम (घंटे, मिनट, सेकंड) और कॉल काउंट भरें। अंत में "Add Entry" बटन दबाएं।',
        'icon': Icons.add,
      },
      {
        'question': 'पुरानी एंट्री को कैसे एडिट करें?',
        'answer': 'डैशबोर्ड पर किसी भी एंट्री के सामने Edit (पेंसिल) आइकन दबाएं। जरूरी बदलाव करके "Update Entry" बटन दबाएं।',
        'icon': Icons.edit,
      },
      {
        'question': 'मासिक रिपोर्ट कैसे देखें?',
        'answer': 'डैशबोर्ड पर बाएं-दाएं स्वाइप करें या नीचे नेवीगेशन बार में "Performance" टैब दबाएं। यहाँ आप अपनी मासिक रिपोर्ट देख सकते हैं।',
        'icon': Icons.bar_chart,
      },
      {
        'question': 'रिपोर्ट को CSV में कैसे एक्सपोर्ट करें?',
        'answer': '"All Reports" सेक्शन में जाएं। जिस महीने की रिपोर्ट चाहिए, उसके सामने "Export Sheet" बटन दबाएं। फाइल आपके फोन में सेव हो जाएगी।',
        'icon': Icons.file_download,
      },
      {
        'question': 'सैलरी कैसे कैलकुलेट होती है?',
        'answer': 'सैलरी = (कॉल काउंट × ₹4.30) + बोनस। बोनस तब मिलता है जब आप 750+ कॉल्स और 100+ घंटे पूरे करते हैं।',
        'icon': Icons.calculate,
      },
      {
        'question': 'डार्क मोड कैसे चालू करें?',
        'answer': 'डैशबोर्ड के टॉप-राइट कॉर्नर में थीम स्विच आइकन दबाएं। यह सूरज/चाँद के आकार का होता है।',
        'icon': Icons.dark_mode,
      },
      {
        'question': 'डेटा कैसे बैकअप करें?',
        'answer': 'फिलहाल ऐप में ऑटो-बैकअप नहीं है। लेकिन आप रेगुलर CSV रिपोर्ट एक्सपोर्ट करके अपना डेटा सेव कर सकते हैं।',
        'icon': Icons.backup,
      },
    ];
  ...
  Widget _buildTroubleshootingItem(BuildContext context, String problem, String solution, IconData icon) {
    return Container(
      margin: const EdgeInsets.only(bottom: 12),
      child: ExpansionTile(
